...
export function bsonDescriptorFrom(value: any): BSONValue {
	let type
	let size = -1
	let bytes = null
...
function bytesify(map: Map<string, BSONValue> | any) {
...
export { convertPOJOtoMap, bytesify, calculateDocumentSize as calculateSize }
